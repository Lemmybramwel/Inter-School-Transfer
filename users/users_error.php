...
<title>Error | E-MaintainPortal</title>
...
<nav class="navbar navbar-default navbar-expand-lg navbar-light">
	...
	<ul class="nav navbar-nav">
		<li class="nav-item active" ><a href="#" class="nav-link">Submit Request</a></li>
 ...
 <div class="col-md-6">
        <div class="tile">
		 <div class="page-header">
                        <h2  style="color:red;">Invalid User Request !!</h2>
                    </div>
                    <div class="alert alert-danger ">
                        <p>Sorry, you've made an invalid request. Please <a href="../admin_panel" class="alert-link alert-info">go back</a> and try again.</p>
                    </div>
        </div>
		</div>
	<div class="col-md-3"></div>
