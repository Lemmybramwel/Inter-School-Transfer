...
<div class="ts-main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="col-md-12">
                        <h2 class="page-title"><center>CURRENT<h style="color: deeppink">ADMIN :</h>  <?php echo $row->name;?> </center></h2>
                        <?php }?>
                        <div class="row">
                            <?php
					...
					";
                            ...
                            <div class="panel panel-danger">
                                ...
                                <div class="panel-body">
									...
									<td>".$row['status']."</td>
									<td>
										<a href='#edit_".$row['roll']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-check'></span> Approve</a>
										<a href='#delete_".$row['roll']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
									</td>
								</tr>";
