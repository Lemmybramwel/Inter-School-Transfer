...
<title>Delete User | E-MaintainPortal</title>
...
<nav class="navbar navbar-default navbar-expand-lg navbar-light">
	...
	<ul class="nav navbar-nav">
		...
		<li class="nav-item active" ><a href="" class="nav-link">Delete User</a></li>
		  ...
		  <div class="page-header">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <p class=" alert-danger">Are you sure you want to delete this record?</p><br>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="../admin_panel" class="btn btn-outline-primary">No</a>
                            </p>
                        </div>
                    </form>
        </div>
